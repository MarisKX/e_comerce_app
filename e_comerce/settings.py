...
SECRET_KEY = 'django-insecure-5dyc*@n+yl7-zl21r((s^9i5bfun5113@5$5^!hy#jo5q-5$^x'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bag.contexts.bag_contents', # Custom made from bag context processor
            ],
            'builtins': [
...
# Need to store messages in session (gitpod twist)!!!
